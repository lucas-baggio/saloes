    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="status-change">
                <div class="old-status">Status anterior: {{ $oldStatus }}</div>
                <div class="arrow">↓</div>
                <div class="new-status">Novo status: {{ $newStatus }}</div>
            </div>
            ...
            <p>Se tiver alguma dúvida sobre esta alteração, entre em contato conosco.</p>
